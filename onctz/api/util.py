...
class Util:
    ...
    def check_json(self, json):
        ...
        try:
            sivec_sap = json.get('sivec_sap')
        except TypeError:
            pass
        except KeyError:
            pass

        return [arpenp, cadesp, caged_resp, caged_trab, caged_emp, censec, detran_cnh, infocrim, jucesp, siel, sivec_nome, sivec_sap]
